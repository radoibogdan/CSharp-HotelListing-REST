...
namespace HotelListing.Controllers
{
    ...
    public class HotelController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetHotel(int id)
        {
            try
            {
                var hotel = await _unitOfWork.Hotels.Get(
                    // get a hotel and the hotels associated with it ???? HERE DIFFERENT
        ...
        public async Task<IActionResult> CreateHotel([FromBody] CreateHotelDTO hotelDTO)
        {
            ...
            try
            {
                // Mapping the content of hotelDTO into an object of type "Hotel" which is a data object
        ...
        // PUT - Authorize ADMINISTRATPT ONLY
        [Authorize]
        [HttpPut("{id:int}")]
